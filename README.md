...
| **Lab 2** | **关键帧动画与插值** | 实现线性插值 (LERP)、球面线性插值 (Slerp)；应用 Catmull-Rom 样条曲线进行平滑处理。 | 💻 [代码](./lab1/2300012297_刘星云/) |
| **Lab 3** | **数据驱动动画** | 运动库检索与特征匹配；实现运动匹配 (Motion Matching) 技术；确保动作切换的自然性。 | 💻 [代码](./lab1/2300012297_刘星云/) |
| **Lab 4** | **物理仿真** | 刚体/柔体动力学模拟；质点弹簧系统 (Mass-Spring System)；实现高效的碰撞检测与响应。 | 💻 [代码](./lab1/2300012297_刘星云/) |
...
<table>
  ...
  <tbody>
    <tr>
      <td><b>Lab 1</b></td>
      <td><b>角色运动学基础</b></td>
      <td>实现正向运动学 (FK) 与逆向运动学 (IK)；解析 BVH 动作文件；处理关节链层级变换。</td>
      <td>💻 <a href="./lab1/2300012297_刘星云_lab1/">代码</a></td>
    </tr>
    <tr>
      <td><b>Lab 2</b></td>
      <td><b>关键帧动画与插值</b></td>
      <td>实现线性插值 (LERP)、球面线性插值 (Slerp)；应用 Catmull-Rom 样条曲线进行平滑处理。</td>
      <td>📄 <a href="./lab2/lab2实验报告_2300012297_刘星云.docx">报告</a></td>
    </tr>
    <tr>
      <td><b>Lab 3</b></td>
      <td><b>数据驱动动画</b></td>
      <td>运动库检索与特征匹配；实现运动匹配 (Motion Matching) 技术；确保动作切换的自然性。</td>
      <td>📄 <a href="./lab3/lab3实验报告_2300012297_刘星云.pdf">报告</a></td>
    </tr>
    <tr>
      <td><b>Lab 4</b></td>
      <td><b>物理仿真</b></td>
      <td>刚体/柔体动力学模拟；质点弹簧系统 (Mass-Spring System)；实现高效的碰撞检测与响应。</td>
      <td>📄 <a href="./lab4/lab4实验报告_2300012297_刘星云.docx">报告</a></td>
    </tr>
  </tbody>
</table>
